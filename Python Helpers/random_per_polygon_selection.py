...
def generate_smaller_graphs(input_dot_file, output_prefix, sizes_per_department, output_excel):
    ...
    for size in sizes_per_department:
        for i in range(1):  # Create 10 graphs per size
            sampled_nodes = set()
...
output_prefix = "notmapped_perpolygon_samples/small_graph"
sizes_per_department = [5, 10, 15, 20, 25,30,35,40,45,50]
output_excel = "notmapped_perpolygon_samples/graph_samples_summary.xlsx"
